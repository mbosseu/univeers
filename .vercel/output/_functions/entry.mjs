...
var middlewareSecret = "41d76336-7917-4804-929e-ccbd8378c357";
//#endregion
...
function deserializeActionResult(res) {
	if (res.type === "error") {
		...
		if (Object.assign({
			...
			"MODE": "production",
			"PROD": true,
			"PUBLIC_SUPABASE_ANON_KEY": "sb_publishable_8dOe6ZKFoWb1GKuPKdI1Yw_Er10tJRB",
			"PUBLIC_SUPABASE_URL": "https://btijpjibghnmqalmbwsv.supabase.co",
			"SITE": void 0,
			"SSR": true
...
[
	...
	},
	{
		...
		"routeData": {
			...
			"params": [],
			"component": "src/pages/api/notify.js",
			"pathname": "/api/notify",
			"prerender": false,
			"fallbackRoutes": [],
			"distURL": [],
...
var _page1 = () => import("./chunks/notify_PqT9wgjZ.mjs");
...
var entrypoint_default = { async fetch(request) {
	...
	else if (url.searchParams.get("x_astro_path_token") === "41d76336-7917-4804-929e-ccbd8378c357") realPath = url.searchParams.get(ASTRO_PATH_PARAM);
